...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"app_self.js":[function(require,module,exports) {
...
function newsFeed() {
  ...
  for (var i = (store.currentPage - 1) * 10; i < store.currentPage * 10; i++) {
    newsList.push("\n    <div class=\"".concat(newsFeed[i].read ? 'bg-red-500' : 'bg-white', " p-6 mt-6 rounded-lg shadow-md transition-colors duration-500 hover:bg-green-100\">\n      <div class=\"flex justify-between\">\n        <a href=\"#/show/").concat(newsFeed[i].id, "\">").concat(newsFeed[i].title, "</a>\n        <p class=\"inline-flex align-center justify-center flex-none text-sm w-10 text-white bg-green-300 rounded-lg px-0 py-2 h-9 ml-4\">").concat(newsFeed[i].comments_count, "</p>\n      </div>\n      <ul class=\"mt-3 flex gap-x-10 text-sm text-gray-500\">\n        <li><i class=\"fas fa-user mr-1\"></i>").concat(newsFeed[i].user, "</li>\n        <li><i class=\"fas fa-heart mr-1\"></i>").concat(newsFeed[i].points, "</li>\n        <li><i class=\"fas fa-clock mr-1\"></i>").concat(newsFeed[i].time_ago, "</li>\n      </ul>\n    </div>\n    "));
  }
...
router();
},{}],"C:/Users/HIVELAB/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/HIVELAB/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app_self.js"], null)
//# sourceMappingURL=/app_self.6c762fbc.js.map